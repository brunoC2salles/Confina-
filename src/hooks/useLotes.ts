...
export function useLotes() {
  ...
  const criarLote = async (input: NovoLoteInput) => {
    ...
    try {
      ...
      return { error: e.message ?? 'Erro ao criar lote' }
    }
  }
  ...
  const registrarPesagem = async (input: PesagemLoteInput) => {
    ...
    try {
      ...
      return { error: e.message ?? 'Erro ao registrar pesagem' }
    }
  }
  ...
  const bifurcarLote = async (input: BifurcacaoInput) => {
    ...
    try {
      ...
      return { error: e.message ?? 'Erro ao bifurcar lote' }
    }
  }
  ...
  const registrarSaida = async (input: SaidaLoteInput) => {
    ...
    try {
      ...
      return { error: e.message ?? 'Erro ao registrar saída' }
    }
  }
  ...
  const avancarCiclo = async (id: string, ciclo: number) => {
    try {
      ...
      return { error: e.message ?? 'Erro ao avançar ciclo' }
    }
  }
  ...
  const encerrarLote = async (id: string) => {
    try {
      ...
      return { error: e.message ?? 'Erro ao encerrar lote' }
    }
  }
  ...
  const excluirLote = async (id: string) => {
    try {
      ...
      return { error: e.message ?? 'Erro ao excluir lote' }
    }
  }
