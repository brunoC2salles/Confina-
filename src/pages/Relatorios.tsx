...
interface Resumo {
  receita_bruta: number; valor_bonus: number
      ...
      {loading ? (
        ...
        <div className="card">
          <div className="empty">
            ...
            <div className="empty-desc">Registre saídas de lote para ver o consolidado financeiro.</div>
          </div>
        </div>
      ) : (
        <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:16 }}>
          <div className="card">
            ...
            <Row label="Venda de animais" value={fmt(resumo.receita_bruta)}/>
            <Row label="Bônus frigorífico" value={fmt(resumo.valor_bonus)}/>
            <Row label="Total receitas brutas" value={fmt(resumo.receita_bruta + resumo.valor_bonus)} bold/>
