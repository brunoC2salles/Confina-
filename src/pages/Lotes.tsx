...
import {
  useLotes, useAnimaisDoLote, useCustoEngine, useVendas, useCustosOperacionais,
...
import type {
  Lote, Animal, SaidaTipo, SaidaModo, RendimentoFaixa, BonusFaixa,
            ...
            <table>
              ...
              <tbody>
                {animais.map(a => {
                  ...
                  const custoPorKg = r && ganho > 0 ? r.custoAcumulado / ganho : null
                  return (
                    <tr key={a.id}>
