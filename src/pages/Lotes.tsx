    ...
    for (const a of animais) {
      ...
      for (const e of Object.values(r.porEtapa)) {
        ...
        if (!etapasPorChave[chave]) {
          etapasPorChave[chave] = { lote_id: e.lote_id, numero: e.numero, tipoCiclo: e.tipoCiclo, dias: 0, ganhoPeso: 0, consumoRacaoKg: 0, consumoConcentradoKg: 0, ganhoPesoConcentrado: 0, custoAlimentacao: 0, custoOperacional: 0 }
        }
        ...
        acc.ganhoPesoConcentrado += e.ganhoPesoConcentrado
